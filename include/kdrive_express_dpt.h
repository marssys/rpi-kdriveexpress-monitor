...
/*!
	...
	\author Copyright (c) 2002-2017 WEINZIERL ENGINEERING GmbH
...
/*!
	Sets DPT-1 (1 bit)
	\param [out] data the group value data buffer to be encoded
...
/*!
	Sets DPT-11: date in KNX format
	NOTE: The year is in KNX DPT11 format: 0..99; >=90 : 20th century; <90 : 21th century <\br>
	e.g. 99 => 1999; 0 => 2000
	\deprecated This function was replaced by kdrive_dpt_encode_dpt11_knx
	\param [out] data the group value data buffer to be encoded
	\param [in] length the length of the group value data buffer (in bytes)
	\param [out] length the length of the formatted group value data buffer (in bits)
	\param [in] year the year value written to the data buffer (0..99)
	\param [in] month the month value written to the data buffer (1..12)
	\param [in] day the day value written to the data buffer (1..31)
	\return success if the datapoint value can be written
	\ingroup kdrive_express_dpt
*/
...
/*!
	...
	NOTE: The year is in KNX DPT11 format: 0..99; >=90 : 20th century; <90 : 21th century <\br>
	e.g. 99 => 1999; 0 => 2000
	This function replace kdrive_dpt_encode_dpt11.
	\param [out] data the group value data buffer to be encoded
	\param [in] length the length of the group value data buffer (in bytes)
	\param [out] length the length of the formatted group value data buffer (in bits)
	\param [in] year the year value written to the data buffer (0..99)
	...
	\ingroup kdrive_express_dpt
*/
kdriveExpress_API error_t kdrive_dpt_encode_dpt11_knx(uint8_t* data, uint32_t* length,
        int32_t year, int32_t month, int32_t day);
...
/*!
	...
	\param [in] length the length of the group value data buffer (in bytes)
	\param [out] length the length of the formatted group value data buffer (in bits)
	\param [in] year the year value written to the data buffer (1990 .. 2089)
	\param [in] month the month value written to the data buffer (1..12)
	\param [in] day the day value written to the data buffer (1..31)
	\return success if the datapoint value can be written
	\ingroup kdrive_express_dpt
*/
kdriveExpress_API error_t kdrive_dpt_encode_dpt11_yyyy(uint8_t* data, uint32_t* length,
        int32_t year, int32_t month, int32_t day);

/*!
	Gets DPT-11: date in KNX format
	NOTE: The year is in KNX DPT11 format: 0..99; >=90 : 20th century; <90 : 21th century <\br>
	e.g. 99 => 1999; 0 => 2000
	\deprecated This function was replaced by kdrive_dpt_decode_dpt11_knx
	\param [in] data the group value data buffer to be decoded
	\param [in] length the length of the group value data buffer (in bytes)
	\param [out] year the year value extracted from the data buffer (0..99)
	\param [out] month the month value extracted from the data buffer (1..12)
	\param [out] day the day value extracted from the data buffer (1..31)
	\return success if the datapoint value can be extracted
	\ingroup kdrive_express_dpt
*/
...
/*!
	...
	\ingroup kdrive_express_dpt
*/
kdriveExpress_API error_t kdrive_dpt_decode_dpt11_knx(const uint8_t* data, uint32_t length,
        int32_t* year, int32_t* month, int32_t* day);
...
/*!
	...
	\param [in] data the group value data buffer to be decoded
	\param [in] length the length of the group value data buffer (in bytes)
	\param [out] year the year value extracted from the data buffer (1990 .. 2089)
	\param [out] month the month value extracted from the data buffer (1..12)
	\param [out] day the day value extracted from the data buffer (1..31)
	\return success if the datapoint value can be extracted
	\ingroup kdrive_express_dpt
*/
kdriveExpress_API error_t kdrive_dpt_decode_dpt11_yyyy(const uint8_t* data, uint32_t length,
        int32_t* year, int32_t* month, int32_t* day);
